...
var main = (function () {
    ...
    Terminal.prototype.repos = function (cmdComponents) {
        ...
        var allRepos = [
            ...
            ['AmiiSwap', 'Nintendo Switch Amiibo switcher homebrew for nfp_mitm.', 'https://github.com/FuryBaguette/AmiiSwap', 'https://raw.githubusercontent.com/FuryBaguette/AmiiSwap/master/icon.jpg'],
            ['MordhauWeaponStats', 'A Mordhau weapon stats comparison website.', 'https://github.com/FuryBaguette/MordhauWeaponStats', '']
        ];
